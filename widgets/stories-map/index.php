...
add_action( 'wp_enqueue_scripts', function() {
	...
	wp_enqueue_script( 'vikalpsangam', plugin_dir_url( __FILE__ ). "/widgets/stories-map/stories-map.js", ["leaflet/js", "leaflet.MarkerCluster/js", "wp-api"], vikalpsangam_VERSION );	
});